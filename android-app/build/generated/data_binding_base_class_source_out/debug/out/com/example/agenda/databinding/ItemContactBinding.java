...
public final class ItemContactBinding implements ViewBinding {
  ...
  private ItemContactBinding(@NonNull CardView rootView, @NonNull TextView tvCategory,
  ...
  public static ItemContactBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemContactBinding((CardView) rootView, tvCategory, tvName, tvPhone);
    }
